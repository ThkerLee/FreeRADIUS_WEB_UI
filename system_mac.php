...
if($_POST){
	...
	$db->query("update userattribute set macbind='".$_POST["macStatus"]."'");
	...
	<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="title_bg2 bd">
	  ...
	  <form action="?" method="post" name="myfrom">
  	  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="bg1" id="userinfolist">
  	    <tbody>
		  <tr>
		    <td width="18%" height="30" align="left" class="bg"><? echo _("是否启用MAC地址绑定")?></td>
	        <td width="82%" align="left" class="bg"><input type="radio" name="macStatus" value="1" <?php if($rs["macStatus"]==1) echo "checked"; ?>><? echo _("启用")?>
				<input type="radio" name="macStatus" value="0" <?php if($rs["macStatus"]=="0") echo "checked"; ?>><? echo _("禁用")?>			</td>
		  </tr>
		  <tr>
