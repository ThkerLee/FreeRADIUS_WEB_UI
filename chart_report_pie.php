    ...
    <td height="43" align="left" valign="top" background="images/li_r4_c5.jpg">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td width="96%" height="35" valign="middle"><font color="#FFFFFF" size="2"><? echo _("营帐管理"); ?></font></td>
		  </tr>
   		</table>
	</td>
		  ...
		  <tr>
		    <td colspan="2" align="left">
				<?php
					...
					open_flash_chart_object( 600, 600, 'chart_report_pie_data.php?startDateTime='.$startDateTime.'&endDateTime='.$endDateTime.'');	
