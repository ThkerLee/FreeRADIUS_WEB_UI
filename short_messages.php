...
$usernums=$db->select_count("userinfo as u,userattribute as a",' a.status=4 and a.userID=u.ID');  

$sql.=" order by enddatetime DESC";
$result=$db->select_all("u.ID,u.UserName,u.account,u.name,u.Mname,u.projectID,u.MAC,u.mobile,u.money,r.enddatetime","userinfo as u,userattribute as a,userrun as r",$sql);
