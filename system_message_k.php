...
if($_POST){  
 	 	  ...
 	 	  $sql=array(
		      ...
		      "content"=>$_POST["content"],
               ...
               if($_POST["userid"]==""  || $_POST["account"] == "" || $_POST["password"] == ""){//userid 用户名 密码 不能为空
                    echo "<script language='javascript'>alert('"._("数据不完整")."');window.location.href='system_message_k.php';</script>";
                    exit();
               }else{
	 ...
	 echo "<script language='javascript'>alert('"._("配置成功")."');window.location.href='system_message_k.php';</script>"; 
 	...
 	<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="title_bg2 bd">
      <tr>
        <td width="89%" class="f-bulue1"> 
            <input type="radio" name="mess" id="add"  value="once"<?php if($_REQUEST['mess']=='' || $_REQUEST['mess']=='add') echo "checked";?> onClick="window.location.href='?mess=add'" style=" display: none;">  <? echo _("开户短信设置")?>
