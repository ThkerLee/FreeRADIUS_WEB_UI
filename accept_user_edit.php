   ...
   $manager_mobile =$_POST["manager_mobile"];
	...
	$sql=array(
        ...
        if(empty($accept_name) || empty($accept_phone)){
         ...
         $db->update_new("accept","ID='".$ID."'",$sql);
         $db->update_new("userinfo","accept_name='".$oldname."'",$sql1);
        }
    ...
    <tbody>
		...
		<td align="right" class="bg">受理人员姓名</td>
                <td align="left" class="bg">
                    ...
                    <input type="hidden" name="oldname" value="<?=$rs['accept_name'];?>">
                    <input type="text" name="accept_name" value="<?=$rs['accept_name'];?>">
                </td>
		</tr> 
		<tr>
		<td width="13%" align="right" class="bg">手机号：</td>
		<td width="83%" align="left" class="bg"><input type="text" name="accept_phone" value="<?=$rs['accept_phone'];?>"></td>
		</tr>
		<tr>
        ...
        <td colspan="2" align="left" class="bg"> 
			<input type="text" name="accept_address" value="<?=$rs['accept_address'];?>"></td>     
       </tr>
